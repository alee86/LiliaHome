...
// âââ DESIGN TOKENS ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const COLORS = {
  cream:  "#F5EFE6",
  sand:   "#E8D5B7",
  taupe:  "#9E8A73",
...
// âââ LOGO SVG (fiel al logo adjunto) âââââââââââââââââââââââââââââââââââââââââ
...
// âââ DATOS INICIALES ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const INIT_PRODUCTS = [
  { id: 1, name: "Aromatizador lÃ­nea hogar 500 ML", price: 9500, image: "https://images.unsplash.com/photo-1609254900033-e39ce00acd93?w=400&h=400&fit=crop", description: "Aromatizador premium para el hogar con aroma duradero. 500 ml de pura fragancia.", details: "DuraciÃ³n: 30 dÃ­as Â· Fragrancias disponibles: lavanda, cedro, vainilla", category: "Hogar" },
  { id: 2, name: "Aromatizador lÃ­nea infantil 500 ML", price: 9500, image: "https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=400&h=400&fit=crop", description: "Formulado especialmente para ambientes de niÃ±os. Suave y seguro.", details: "Sin alcohol Â· Fragrancias: talco, manzanilla, bebÃ© fresco", category: "Infantil" },
  { id: 3, name: "Aromatizador lÃ­nea perfume 500ML", price: 9500, image: "https://images.unsplash.com/photo-1585515320310-39b22bc1cb60?w=400&h=400&fit=crop", description: "Inspirado en los mejores perfumes del mundo. Una experiencia sensorial Ãºnica.", details: "Inspiraciones: Chanel, Dior, Carolina Herrera Â· 500 ml", category: "Perfume" },
  { id: 4, name: "Gatillo", price: 1000, image: "https://images.unsplash.com/photo-1608244876244-fe906e37e816?w=400&h=400&fit=crop", description: "Gatillo spray de repuesto compatible con todos nuestros aromatizadores 500ml.", details: "Material: plÃ¡stico reciclado Â· Ajuste universal", category: "Accesorios" },
  { id: 5, name: "Aerosol 270 ML", price: 6500, image: "https://images.unsplash.com/photo-1615996001641-b4b4d1f2d4f0?w=400&h=400&fit=crop", description: "Aerosol instantÃ¡neo para refrescar ambientes al instante. FÃ¡cil de usar.", details: "PresentaciÃ³n compacta Â· Ideal para baÃ±os y autos Â· 270 ml", category: "Hogar" },
  { id: 6, name: "Difusor aromÃ¡tico 130ML", price: 6500, image: "https://images.unsplash.com/photo-1608244876244-fe906e37e816?w=400&h=400&fit=crop", description: "Difusor con palitos de ratÃ¡n para una fragancia constante y elegante.", details: "Incluye 6 palitos Â· DuraciÃ³n: 45 dÃ­as Â· 130 ml", category: "Hogar" },
  { id: 7, name: "Difusor de auto 10 ML", price: 6500, image: "https://images.unsplash.com/photo-1609254900033-e39ce00acd93?w=400&h=400&fit=crop", description: "MantÃ©n tu auto siempre perfumado. DiseÃ±o elegante para rejilla de ventilaciÃ³n.", details: "Clip universal Â· Fragrancias: madera, fresco, cÃ­trico Â· 10 ml", category: "Auto" },
  { id: 8, name: "Aromatizador auto 120ML", price: 3500, image: "https://images.unsplash.com/photo-1585515320310-39b22bc1cb60?w=400&h=400&fit=crop", description: "Spray compacto especÃ­fico para automÃ³viles. Elimina olores y perfuma al instante.", details: "120 ml Â· Compatible con ambientadores de auto", category: "Auto" },
  { id: 9, name: "Colonia infantil 120 ML", price: 6500, image: "https://images.unsplash.com/photo-1607623814075-e51df1bdc82f?w=400&h=400&fit=crop", description: "Suave colonia para bebÃ©s y niÃ±os. HipoalergÃ©nica y sin alcohol.", details: "DermatolÃ³gicamente testeada Â· 120 ml Â· Apto desde 0 meses", category: "Infantil" },
  { id: 10, name: "Cubo", price: 5000, image: "https://images.unsplash.com/photo-1570129477492-45667003000f?w=400&h=400&fit=crop", description: "Cubo aromatizador decorativo. Fusiona diseÃ±o y fragancia en un solo objeto.", details: "Material: madera Â· Disponible en varios aromas Â· Ideal regalo", category: "Hogar" },
];
...
const INIT_CAROUSEL = [
  ...
  { id: 3, url: "https://images.unsplash.com/photo-1608244876244-fe906e37e816?w=1200&h=600&fit=crop", link: null, caption: "DescubrÃ­ nuestra lÃ­nea premium" },
];

const INIT_TESTIMONIALS = [
  { id: 1, name: "MarÃ­a GarcÃ­a", text: "Productos de excelente calidad. Me encantÃ³ el aroma del difusor, dura muchÃ­simo!", rating: 5 },
  { id: 2, name: "Juan LÃ³pez", text: "Muy buen servicio y entrega rÃ¡pida. Los aromatizadores son increÃ­bles.", rating: 5 },
  { id: 3, name: "Carolina SÃ¡nchez", text: "Lilia Home cambiÃ³ mi hogar completamente. Recomendado 100%.", rating: 5 },
];

// âââ STYLES GLOBALES âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const gStyle = `
...
// âââ MAIN APP ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
export default function App() {
  ...
  const sendWhatsApp = () => {
    const items = cart.map(i => `â¢ ${i.name} x${i.qty} â $${(i.price * i.qty).toLocaleString("es-AR")}`).join("\n");
    const msg = `Hola! Quiero hacer el siguiente pedido:\n\n${items}\n\n*Total: $${cartTotal.toLocaleString("es-AR")}*\n\nÂ¿CuÃ¡l es la forma de pago y envÃ­o?`;
    ...
    <div style={{ fontFamily: "'Lato', sans-serif", background: COLORS.cream, minHeight: "100vh" }}>
        ...
        {carousel.map((img, i) => (
          <div key={img.id} style={{ position: "absolute", inset: 0, opacity: i === carouselIdx ? 1 : 0, transition: "opacity 1s ease", cursor: img.link ? "pointer" : "default" }}
            ...
            <div style={{ position: "absolute", bottom: 60, left: "50%", transform: "translateX(-50%)", textAlign: "center", color: "#fff" }}>
              ...
              {img.link && <span style={{ fontSize: 12, background: "rgba(255,255,255,0.2)", padding: "4px 12px", borderRadius: 20, marginTop: 8, display: "inline-block" }}>Ver producto â</span>}
            </div>
          </div>
        ))}
        {/* Logo overlay */}
      ...
      <section id="productos" style={{ maxWidth: 1200, margin: "0 auto", padding: "64px 20px" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <p style={{ fontFamily: "'Dancing Script', cursive", fontSize: 20, color: COLORS.accent, margin: 0 }}>Nuestra colecciÃ³n</p>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 40, marginBottom: 40 }}>
            <div>
              ...
              <p style={{ color: COLORS.taupe, fontSize: 13, lineHeight: 1.8, marginTop: 16 }}>Aromas Ãºnicos que transforman cada rincÃ³n de tu hogar.</p>
            </div>
            <div>
          ...
          <div style={{ borderTop: `1px solid ${COLORS.brown}`, paddingTop: 24, textAlign: "center", color: COLORS.taupe, fontSize: 12 }}>
            Â© 2024 Lilia HOME Â· Todos los derechos reservados
          </div>
        </div>
      </footer>

      {/* ââ WHATSAPP FLOTANTE ââ */}
          ...
          <div className="slide-up" style={{ position: "absolute", right: 0, top: 0, bottom: 0, width: "min(420px, 100vw)", background: COLORS.white, overflowY: "auto", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ flex: 1, padding: "16px 24px", overflowY: "auto" }}>
              {cart.length === 0 ? (
                <div style={{ textAlign: "center", padding: "60px 0", color: COLORS.taupe }}>
                  ...
                  <p style={{ fontFamily: "'Cinzel', serif" }}>Tu carrito estÃ¡ vacÃ­o</p>
                </div>
              ) : cart.map(item => (
                <div key={item.id} style={{ display: "flex", gap: 16, padding: "16px 0", borderBottom: `1px solid ${COLORS.sand}` }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <button onClick={() => updateQty(item.id, item.qty - 1)} style={{ width: 28, height: 28, borderRadius: "50%", border: `1.5px solid ${COLORS.sand}`, background: "none", cursor: "pointer", color: COLORS.brown, fontSize: 18, display: "flex", alignItems: "center", justifyContent: "center" }}>â</button>
            ...
            {cart.length > 0 && (
              <div style={{ padding: "20px 24px", borderTop: `1px solid ${COLORS.sand}` }}>
                ...
                <p style={{ textAlign: "center", fontSize: 11, color: COLORS.taupe, marginTop: 10 }}>Te enviamos un mensaje con los detalles de pago y envÃ­o</p>
              </div>
            )}
          </div>
        </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: 360 }}>
              ...
              <div style={{ padding: "36px 32px" }}>
                ...
                <div style={{ background: COLORS.cream, borderRadius: 10, padding: "12px 16px", marginBottom: 24 }}>
                  <p style={{ color: COLORS.brown, fontSize: 13, margin: 0 }}>ð {selectedProduct.details}</p>
                </div>
...
// âââ ADMIN PAGE âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    return (
      <div style={{ minHeight: "100vh", background: COLORS.cream, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Lato', sans-serif" }}>
        ...
        <div style={{ background: COLORS.white, borderRadius: 20, padding: 48, width: "min(400px, 95vw)", boxShadow: "0 16px 60px rgba(61,43,31,0.15)", textAlign: "center" }}>
          ...
          <p style={{ color: COLORS.taupe, fontSize: 13, marginBottom: 28 }}>IngresÃ¡ tu contraseÃ±a para continuar</p>
          <input type="password" placeholder="ContraseÃ±a" value={adminPass} onChange={e => setAdminPass(e.target.value)}
            onKeyDown={e => e.key === "Enter" && (adminPass === "admin123" ? setAdminAuth(true) : alert("ContraseÃ±a incorrecta"))}
          ...
          <button className="lilia-btn" style={{ width: "100%", borderRadius: 10, padding: 14, fontSize: 14 }}
            onClick={() => adminPass === "admin123" ? setAdminAuth(true) : alert("ContraseÃ±a incorrecta")}>
            Ingresar
          </button>
          <button onClick={goStore} style={{ marginTop: 12, background: "none", border: "none", cursor: "pointer", color: COLORS.taupe, fontSize: 13 }}>â Volver a la tienda</button>
        </div>
      </div>
    );
  }
    ...
    <div style={{ minHeight: "100vh", background: COLORS.cream, fontFamily: "'Lato', sans-serif" }}>
      ...
      <header style={{ background: COLORS.dark, color: COLORS.sand, padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <span style={{ fontFamily: "'Cinzel', serif", fontSize: 16, color: COLORS.accent }}>Panel Admin Â· Lilia HOME</span>
        </div>
              ...
              {(editItem !== null) && (
                <div className="fade-in" style={{ background: COLORS.white, borderRadius: 14, padding: 28, marginBottom: 28, border: `1.5px solid ${COLORS.sand}` }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                    ...
                    <Field label="CategorÃ­a" field="category" obj={editItem} setObj={setEditItem} />
                    <Field label="URL Imagen" field="image" obj={editItem} setObj={setEditItem} />
                    <div style={{ gridColumn: "1/-1" }}><Field label="DescripciÃ³n corta" field="description" obj={editItem} setObj={setEditItem} /></div>
                    <div style={{ gridColumn: "1/-1" }}><Field label="Detalles tÃ©cnicos" field="details" obj={editItem} setObj={setEditItem} /></div>
                  </div>
                ...
                {products.map(p => (
                  <div key={p.id} style={{ background: COLORS.white, borderRadius: 12, padding: "16px 20px", display: "flex", alignItems: "center", gap: 16, boxShadow: "0 2px 8px rgba(61,43,31,0.05)" }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <p style={{ color: COLORS.taupe, margin: 0, fontSize: 13 }}>{p.category} Â· ${p.price.toLocaleString("es-AR")}</p>
                    </div>
            ...
            <div>
              ...
              {editItem !== null && (
                <div className="fade-in" style={{ background: COLORS.white, borderRadius: 14, padding: 28, marginBottom: 28, border: `1.5px solid ${COLORS.sand}` }}>
                  ...
                  <Field label="PuntuaciÃ³n (1-5)" field="rating" obj={editItem} setObj={setEditItem} type="number" />
                  <div style={{ display: "flex", gap: 10 }}>
